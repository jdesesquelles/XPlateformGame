...
extern "C"
{
	...
	JNIEXPORT void JNICALL Java_co_fabrk_app_MainActivity_SetSurface( JNIEnv* env, jclass clazz, jobject javaSurface )
	{
	}

	JNIEXPORT void JNICALL Java_co_fabrk_app_MainActivity_SetSurfaceSize( JNIEnv* env, jclass clazz, int Width, int Height )
	{
	...
	JNIEXPORT void JNICALL Java_co_fabrk_app_MainActivity_DrawFrame( JNIEnv* env, jobject obj )
	{
		// call our callback
		OnDrawFrame();
